...
I'm interested in developing data-centric AI systems. Nearly every industry has figured out how to vertically align critical knowledge bases that can positively impact decision making, but aligning what's possible with the computational, engineering, and capital investment restrictions requires a re-vamped mental framework to consider. Thus is because information that forumlates knowledge bases often serve different end-purposes, with an everchanging level of abstraction and dimensional analysis to create value. For example, the average file cabinet is a knowledge base of information, but is a substationally outdated method in interacting information. It's an investment to store information securley and neatly at it's core. Thus, information and the raw data that generates information should be treated as an asset class, epsecially when considered to be used as a collective part of artifical intelligence generation. This is especially important for startups, research-oriented investments, or any zero-to-one building experience. As an asset class, data can be valuable when trying to gain a strategic advantage and could always be considered as a *potential* advantage when collected organically. However, data can also be used incorrectly and consequentially overvalued as a strategic asset; therefore, measuring the value of information is where I start for any data-centric AI development process. 
